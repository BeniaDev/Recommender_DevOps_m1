...
from src.utils import get_rating_matrix, load_dataset

class ALSRecommender():
    def __init__(self, k=5, lmbda=0.1, max_epochs=15, error_metric='rmse', verbose=True):
